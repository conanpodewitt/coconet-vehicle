...
def extract_network_from_function(
...
def extract_network_from_lambda(
    lambda_node: Dict[str, Any], network_info: Dict[str, Any]
):
...
def extract_network_from_binder(
    binder_node: Dict[str, Any], network_info: Dict[str, Any]
):
...
def main():
    parser = argparse.ArgumentParser(
        description="Extract network definitions from Vehicle AST JSON"
    )
    ...
    parser.add_argument(
        "--names-only", action="store_true", help="Only output network names"
    )
